...
def company_profile(request):
    ...
    if request.method == "POST":
        ...
        company.notify_email_contact    = request.POST.get("notify_email_contact", company.notify_email_contact)
        company.notify_telegram_contact = request.POST.get("notify_telegram_contact", company.notify_telegram_contact)
        company.notify_whatsapp_contact = request.POST.get("notify_whatsapp_contact", company.notify_whatsapp_contact)
