...
urlpatterns = [
    ...
    path("sfr/efs1/1.1/pdf/", views.sfr_efs1_11_pdf, name="sfr_efs1_11_pdf"),
    path("sfr/efs1/1.2/", views.sfr_efs1_12, name="sfr_efs1_12"),
    path("sfr/efs1/1.2/xml/", views.sfr_efs1_12_xml, name="sfr_efs1_12_xml"),
    path("sfr/efs1/1.2/pdf/", views.sfr_efs1_12_pdf, name="sfr_efs1_12_pdf"),
    # События
    path("events/", views.events_list, name="events_list"),
    path("events/count/", views.events_count_api, name="events_count"),
